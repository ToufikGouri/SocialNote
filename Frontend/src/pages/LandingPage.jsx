...
const LandingPage = () => {
    return (
        <>
            <div className='md:flex flex-col items-center h-screen linearBG'>

                <div className="md:flex text-white">
                    {/* Left side */}
                    <div className="sectionLeft flex justify-center md:w-1/2">
                        <h1 className='text-5xl mt-5 md:mt-32 leading-tight text-center max-md:mx-4 md:text-left md:text-6xl md:w-3/4 lg:w-2/4'>
                    ...
                    {/* Right side */}
                    <div className="sectionRight md:pt-28 lg:pt-0 max-md:my-8 md:w-1/2">

                        <div className="notes max-md:justify-center flex items-center">
                            <img src={Notes} className='h-36 sm:h-48 lg:h-80' alt="Add notes easily" />
                            <h1 className='text-xl text-center italic sm:text-4xl'>Add private <br /> notes</h1>
                        </div>

                        <div className="socialMedia max-md:justify-center flex items-center">
                            <h1 className='text-xl text-center italic sm:text-4xl relative max-md:left-4'>Connect with <br /> others</h1>
                            <img src={SocialMedia} className='h-32 sm:h-48 lg:h-80' alt="Connect with others" />
                        </div>
