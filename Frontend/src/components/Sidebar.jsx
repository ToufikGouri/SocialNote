...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <div onClick={() => navigate("/")} className='hidden max-sm:flex items-center w-full fixed z-50 h-12 ps-2 cursor-pointer bg-white'>
            ...
            {/* Main container */}
            <div className="fixed z-50 max-sm:bottom-0 w-full sm:w-2/12 sm:h-screen flex flex-col justify-center items-center bg-white ">
                ...
                {/* Other buttons */}
                <div className="flex sm:flex-col justify-evenly items-center h-14 w-full sm:h-2/3 sm:w-1/4">
